package ru.hypertheosx.qa.features.cart.component;
...
public class ProductCardComponent {
    ...
    private SelenideElement name() {
        return root.$("[data-test='inventory-item-name']");
    }

    private SelenideElement description() {
        return root.$("[data-test='inventory-item-desc']");
    }

    private SelenideElement price() {
        return root.$("[data-test='inventory-item-price']");
    }
